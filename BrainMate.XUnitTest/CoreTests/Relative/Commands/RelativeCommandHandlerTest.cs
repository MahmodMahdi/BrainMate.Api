...
namespace BrainMate.XUnitTest.CoreTests.Relative.Commands
{
    public class RelativeCommandHandlerTest
    {
        ...
        public async Task Handle_AddRelative_Should_Add_Data_And_StatusCode201()
        {
            ...
            var AddRelativeCommand = new AddRelativeCommand() { Name = "Mohamed", RelationShip = "Brother", RelationShipDegree = 1, Description = "The closest person to me", Age = 30, Address = "Tanta", PhoneNumber = "0123333", Job = "Pilot" };
        ...
        public async Task Handle_UpdateRelative_Should_Return_StatusCode404()
        {
            // Arrange
            var handler = new RelativeCommandHandler(_relativeServiceMock.Object, _mapperMock, _localizerMock.Object);
            var updateRelativeCommand = new UpdateRelativeCommand() { Id = 1, Name = "Mohamed", RelationShip = "Brother", RelationShipDegree = 1, Description = "The closest person to me", Age = 30, Address = "Tanta", PhoneNumber = "0123333", Job = "Pilot" };
            int xResult = 0;
