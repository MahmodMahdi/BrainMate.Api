...
namespace BrainMate.XUnitTest.CoreTests.Relative.Queries
{
	public class RelativeQueryHandlerTest
	{
		...
		public async Task Handle_RelativeById_Where_Relative_NotFound_Return_StatusCode404(int id)
		{
			...
			{
				new Relatives(){Id = 1,NameAr="محمد",NameEn = "Mohamed",RelationShip= "Brother",RelationShipDegree=1,Description="The closest person to me",Age = 30,Address = "Tanta",Phone="0123333",Job = "Pilot",Image="/Relative/8bc70c2ef11540b3b8725f9d2d2f7734.jpg"}
			};
		...
		public async Task Handle_PatientById_Where_Patient_Found_Return_StatusCode200(int id)
		{
			...
			var relativeList = new List<Relatives>()
			{
				new Relatives(){Id = 1,NameAr="محمد",NameEn = "Mohamed",RelationShip= "Brother",RelationShipDegree=1,Description="The closest person to me",Age = 30,Address = "Tanta",Phone="0123333",Job = "Pilot",Image="/Foods/8bc70c2ef11540b3b8725f9d2d2f7734.jpg"}
			};
