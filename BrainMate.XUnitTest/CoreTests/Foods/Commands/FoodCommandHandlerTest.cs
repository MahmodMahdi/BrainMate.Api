...
//            var addFoodCommand = new AddFoodCommand() { Name = "Salad", Type = "Breakfast", Time = new TimeOnly(10, 30) };
...
//            // Arrange
//            var handler = new FoodCommandHandler(_foodServiceMock.Object, _mapperMock, _localizerMock.Object);
//            var updateFoodCommand = new UpdateFoodCommand() { Id = 1, Name = "Salad", Type = "Breakfast", Time = new TimeOnly(10, 30) };
//            Food? food = null;
//            int xResult = 0;
