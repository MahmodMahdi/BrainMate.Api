...
namespace BrainMate.XUnitTest.CoreTests.Foods.Queries
{
	public class FoodQueryHandlerTest
	{
		...
		public async Task Handle_FoodList_Should_NotNull_And_NotEmpty()
		{
			...
			{
				new Food(){Id = 1,NameAr="سلطة",NameEn = "Salad",Type= "Breakfast",Time= new TimeOnly(10,30),Image="/Foods/8bc70c2ef11540b3b8725f9d2d2f7734.jpg"}
			};
			// Arrange 
		...
		public async Task Handle_FoodById_Where_Food_NotFound_Return_StatusCode404(int id)
		{
			...
			{
				new Food(){Id = 1,NameAr="سلطة",NameEn = "Salad",Type= "Breakfast",Time= new TimeOnly(10,30),Image="/Foods/8bc70c2ef11540b3b8725f9d2d2f7734.jpg"},
				new Food(){Id = 2,NameAr="لحوم",NameEn = "Meats",Type= "dinner",Time= new TimeOnly(6,30),Image="/Foods/8bc70c2ef11534j7b8725f9d2d2f7734.jpg"},
			};
			// Arrange 
