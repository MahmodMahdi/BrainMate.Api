using AutoMapper;
using BrainMate.Core.Features.AlzheimerPatient.Queries.Handler;
...
namespace BrainMate.XUnitTest.CoreTests.Patients.Queries
{
	public class PatientQueryHandlerTest
	{
		...
		public async Task Handle_PatientById_Where_Patient_NotFound_Return_StatusCode404(int id)
		{
			...
			{
				new Patient(){Id = 1,NameAr="محمد",NameEn = "Mohamed",BirthDate = new DateOnly(2000,2,2),Address = "Tanta",Phone="01234445533",Job = "Pilot",Image="/Patient/8bc70c2ef11540b3b8725f9d2d2f7734.jpg"}
			};
		...
		public async Task Handle_PatientById_Where_Patient_Found_Return_StatusCode200(int id)
		{
			...
			var patientList = new List<Patient>()
			{
				new Patient(){Id = 1,NameAr="محمد",NameEn = "Mohamed",BirthDate = new DateOnly(2000,2,2),Address = "Tanta",Phone="01238888333",Job = "Pilot",Image="/Patient/8bc70c2ef11540b3b8725f9d2d2f7734.jpg"}
			};
