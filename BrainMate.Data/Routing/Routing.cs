namespace BrainMate.Data.Routing
{
    public static class Routing
    {
        ...
        public static class PatientRouting
        {
            ...
            public const string Profile = Prefix + "/Patient-Profile";
            public const string Update = Prefix + "/Update-Profile";
            public const string Delete = Prefix + "/Delete-Account";

            public const string LockUnlockCaregiver = Prefix + "/LockUnlockCaregiver";
        }
        public static class CaregiverRouting
        {
            public const string Prefix = Rule + "Caregiver";
            public const string Profile = Prefix + "/Caregiver-Profile";
            public const string Update = Prefix + "/Update-Profile";
            public const string Delete = Prefix + "/Delete-Account";
        }
